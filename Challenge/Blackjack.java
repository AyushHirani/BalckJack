...
public class Blackjack {
    ...
    public static void main(String[] args) {
        ...
        int faceDownCard = drawRandomCard();
        int dealerTotal = firstCard+faceDownCard;
        ...
        while(dealerTotal<17){
            int dNewCard = drawRandomCard();
            dealerTotal += dNewCard;
            System.out.println("\n Dealer gets a \n" + cardString(dNewCard));
    ...
    public static String hitOrStay(){
        System.out.println("Would you like to hit ot stay?");
